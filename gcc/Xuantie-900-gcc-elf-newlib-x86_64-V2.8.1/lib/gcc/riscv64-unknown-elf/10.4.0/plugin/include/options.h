...
enum opt_code
{
  ...
  /* OPT_pthread = 1696, */                  /* -pthread */
  OPT_quiet = 1697,                          /* -quiet */
  OPT_r = 1698,                              /* -r */
  ...
  OPT_std_c__23 = 1731,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1732, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1733, */                /* -std=c++2b */
  ...
  OPT_std_gnu__23 = 1758,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1759, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1760, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1761,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1762,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1763,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1764, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1765, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1766,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1767, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1768,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1769,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1770, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1771, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1772,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1773, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1774, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1775, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1776, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1777, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1778,                     /* -std=legacy */
  OPT_symbol_ = 1779,                        /* -symbol= */
  OPT_symbolic = 1780,                       /* -symbolic */
  OPT_t = 1781,                              /* -t */
  OPT_time = 1782,                           /* -time */
  OPT_time_ = 1783,                          /* -time= */
  OPT_traditional = 1784,                    /* -traditional */
  OPT_traditional_cpp = 1785,                /* -traditional-cpp */
  OPT_tree_stats = 1786,                     /* -tree-stats */
  OPT_trigraphs = 1787,                      /* -trigraphs */
  OPT_type_stats = 1788,                     /* -type-stats */
  OPT_u = 1789,                              /* -u */
  OPT_undef = 1790,                          /* -undef */
  OPT_v = 1791,                              /* -v */
  OPT_version = 1792,                        /* -version */
  OPT_w = 1793,                              /* -w */
  OPT_wrapper = 1794,                        /* -wrapper */
  OPT_x = 1795,                              /* -x */
  OPT_z = 1796,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
