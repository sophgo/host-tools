...
#endif
  E_M64QImode,             /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M32HImode,             /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M16SImode,             /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M8DImode,              /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M4TImode,              /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M32BFmode,             /* config/riscv/riscv-modes.def:200 */
#define HAVE_M32BFmode
#ifdef USE_ENUM_MODES
#define M32BFmode E_M32BFmode
#else
#define M32BFmode ((void) 0, E_M32BFmode)
#endif
  E_M32HFmode,             /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M2x32BFmode,           /* config/riscv/riscv-modes.def:200 */
#define HAVE_M2x32BFmode
#ifdef USE_ENUM_MODES
#define M2x32BFmode E_M2x32BFmode
#else
#define M2x32BFmode ((void) 0, E_M2x32BFmode)
#endif
  E_M2x32HFmode,           /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M16SFmode,             /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M2x16SFmode,           /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M8DFmode,              /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M2x8DFmode,            /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M4TFmode,              /* config/riscv/riscv-modes.def:200 */
...
#endif
  E_M2x4TFmode,            /* config/riscv/riscv-modes.def:200 */
...
#define VNx16TFmode ((void) 0, E_VNx16TFmode)
  ...
  MIN_MODE_VECTOR_FLOAT = E_VNx2BFmode,
